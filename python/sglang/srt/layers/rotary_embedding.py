...
class RotaryEmbedding(nn.Module):
    ...
    def forward(
        ...
        """PyTorch-native implementation with robust position handling."""
        ...
        # Handle positions that exceed cache size by using modulo for wraparound
        # This matches the behavior of many transformer implementations
        max_pos = self.max_position_embeddings
        positions_wrapped = positions % max_pos
