...
if __name__ == "__main__":
    ...
    test_generate("/data/models/TinyLlama-1.1B-Chat-v0.4", 1)
    # You can enable multi-GPU testing once NCCL is properly configured:
    # test_generate("/tmp-data/models/llama-2-7b", 2)
